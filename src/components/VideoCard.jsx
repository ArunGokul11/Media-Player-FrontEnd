...
function VideoCard({ displayVideo, setDeleteVideoStatus }) {
  ...
  const dragStarted = (e,id)=>{
    console.log(`videocard with id ${id} started message`);
  ...
  return (
    <>
      <Card style={{ width: '18rem' }}
       className='my-5 'draggable onDragStart={(e)=>dragStarted(e,displayVideo.id)}>
      ...
      >
        ...
        <Modal.Footer>
          ...
          <Button variant="primary">Understo</Button> */}
        </Modal.Footer>
      </Modal>
    </>
  )
